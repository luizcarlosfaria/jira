...
```
docker run --name customNginx -d --hostname customNginx -p 80:8080 -p 8005:8005 -v /some/jira/data:/var/atlassian/application-data/jira/ -v  /some/jira/install:/opt/atlassian/jira/ luizcarlosfaria/jira
```
